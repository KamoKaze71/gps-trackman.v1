...
public class SaveStateDemoActivity extends FragmentActivity {
     ...
     * {@link android.os.Parcelable}s objects can be saved after rotation of the device.
     * <p>
     * Storing custom {@link android.os.Parcelable} objects directly in the {@link android.os.Bundle} provided by the
     * {@link #onActivityCreated(android.os.Bundle)} method will throw a {@code ClassNotFoundException}. This
     ...
     * <br>
     * A workaround to store these objects is to wrap the custom {@link android.os.Parcelable} objects in a new
     * {@link android.os.Bundle} object.
     * <p>
     * However, note that it is safe to store {@link android.os.Parcelable} objects from the Maps API (eg.
     * MarkerOptions, LatLng, etc.) directly in the Bundle provided by the
     * {@link #onActivityCreated(android.os.Bundle)} method.
     */
